...
class _PlusMenuSheetState extends State<_PlusMenuSheet> {
  _PlusMenuView _view = _PlusMenuView.menu;
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: _view == _PlusMenuView.menu,
      onPopInvokedWithResult: (didPop, _) {
        if (!didPop) {
          setState(() => _view = _PlusMenuView.menu);
        }
      },
      child: AnimatedSize(
        duration: const Duration(milliseconds: 200),
        ...
        child: Padding(
          ...
          child: switch (_view) {
            _PlusMenuView.menu => _buildMenu(),
            _PlusMenuView.task => _buildTaskForm(),
          },
        ),
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () => setState(() => _view = _PlusMenuView.task),
          ),
          const SizedBox(height: 8),
        ],
      ),
            ...
            Row(
              children: [
                IconButton(
                  ...
                  onPressed: () => setState(() => _view = _PlusMenuView.menu),
                ),
